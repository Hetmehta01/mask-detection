...
def camera(request):
    if request.method == 'POST':
        ...
        training_set = train_datagen.flow_from_directory(
            '/Users/kunjan/PycharmProjects/hacknitr/mask_detection_proj/mask_detection_app/train',
            target_size=(150, 150),
            batch_size=16,
            class_mode='binary')

        test_set = test_datagen.flow_from_directory(
            '/Users/kunjan/PycharmProjects/hacknitr/mask_detection_proj/mask_detection_app/test',
            target_size=(150, 150),
            batch_size=16,
            class_mode='binary')
